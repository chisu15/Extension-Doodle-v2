chrome.runtime.onInstalled.addListener(() => {
    ...
    <img class="lnXdpd" alt="Google" src="https://viet-doodle-gallery.vercel.app/static/media/vietdoodle.dd3582d90229ed455cad.png" height="180 px" width="auto" data-atf="1" data-frt="0" object-fit="contain" margin-top="auto">
    </a>`;
    let dataExtra = `<a href="https://viet-doodle-gallery.vercel.app/" target="_blank"><img class="jfN4p" src="https://viet-doodle-gallery.vercel.app/static/media/vietdoodle.dd3582d90229ed455cad.png" style="background:none" alt="Google" height="30px" width="92px" data-csiid="1" data-atf="1" object-fit="contain"></a>`;
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    ...
    if (request.action === "showGamePopup") {
        if (!request.game) {
            console.error("[background.js] No game URL found in request.");
            sendResponse({ status: "error", message: "No game URL" });
            return;
        }

        console.log("[background.js] Forwarding to content.js with gameURL:", request.game);
        ...
        chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
            if (tabs.length > 0) {
                chrome.tabs.sendMessage(tabs[0].id, {
                    ...
                    console.log("[background.js] Message sent to content.js. Response:", response);
                });
            } else {
